...
function dialog(){
    //show this only on silvester
   alert("Happy new year everyone!!!! Thank you soooo much for all the likes and awesome comments!!!!") 
}
function countdown(){
    var display = document.getElementsByClassName("countdown");
    
    var now = new Date();
    var silvester = new Date(now.getFullYear()+1, 0, 1, 0, 0);
    //r = remaining
    ...
    //not mine fireworks
    //awesome job "SEO website designing"!!
function a(){
...
controller.init();
window.requestAnimationFrame(controller.animation);    
}